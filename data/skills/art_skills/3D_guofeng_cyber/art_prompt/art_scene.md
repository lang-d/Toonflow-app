---
name: art_scene
description: 3D国风赛博场景基础图视觉手册。将资产事实与视觉设计推导编译为可复用的图片提示词。
metaData: art_skills
---
# 3D国风赛博场景图生成 · 约束手册
...
本手册负责把已确认事实编译为3D国风赛博场景基础图提示词，不负责创作剧情、身份、关系、地点、品牌、能力或世界规则。
...
```text
3D国风赛博场景设定图，environment design sheet，location reference，single image，
...
建筑中轴、地标和通行路径先成立，再布置数据线路、能量节点和系统状态色，{已确认时段、天气和实际光源}，
