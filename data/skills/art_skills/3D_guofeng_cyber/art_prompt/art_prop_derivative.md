...
description: 3D国风赛博道具衍生图视觉手册。将资产事实与视觉设计推导编译为可复用的图片提示词。
metaData: art_skills
---
# 道具衍生状态生成 · 约束手册
...
本手册负责把已确认事实编译为3D国风赛博道具衍生图提示词，不负责创作剧情、身份、关系、地点、品牌、能力或世界规则。
...
```text
3D国风赛博道具衍生设定图，based on the reference prop design，same object，
...
传统器型与科技模块的接口、能量来源和材质边界明确，发光区域有功能依据，完整物体可见，保持同一道具身份，
