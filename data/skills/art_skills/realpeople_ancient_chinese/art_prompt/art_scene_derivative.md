...
description: 真人中国古风场景衍生图视觉手册。将资产事实与视觉设计推导编译为可复用的图片提示词。
metaData: art_skills
---
# 场景衍生资产生成 · 约束手册
...
本手册负责把已确认事实编译为真人中国古风场景衍生图提示词，不负责创作剧情、身份、关系、地点、品牌、能力或世界规则。
...
```text
真人中国古风场景衍生设定图，based on the reference scene design，same location，single image，
...
院落、厅堂、街巷和自然环境具有真实尺度、出入口与生活痕迹，不做影楼布景拼贴，保持一致的材质响应和可追溯光源，
