---
name: art_character
description: 2D扁平设计角色基础图视觉手册。将资产事实与视觉设计推导编译为可复用的图片提示词。
metaData: art_skills
---
# 人物基础形象生成 · 扁平风约束手册
...
本手册负责把已确认事实编译为2D扁平设计角色基础图提示词，不负责创作剧情、身份、关系、地点、品牌、能力或世界规则。
...
```text
2D扁平设计角色设定图，character design sheet，character turnaround，
{来自 assetFoundation 的年龄、性别、身份、面部、体态、发型和基础服装事实}，
{来自 visualDesignRationale 的识别度策略、观众缘处理和审美修正}，
以可识别剪影、少量关键形状和稳定色块区分人物，五官和服装细节保持可读而不过载，
