---
name: art_scene
description: 3D中国传统场景基础图视觉手册。将资产事实与视觉设计推导编译为可复用的图片提示词。
metaData: art_skills
---
# 场景图生成 · 约束手册
...
本手册负责把已确认事实编译为3D中国传统场景基础图提示词，不负责创作剧情、身份、关系、地点、品牌、能力或世界规则。
...
```text
3D中国传统场景设定图，environment design sheet，location reference，single image，
...
建筑中轴、院落进深、门窗和礼仪站位共同组织空间，材料尺度和年代痕迹可信，{已确认时段、天气和实际光源}，
