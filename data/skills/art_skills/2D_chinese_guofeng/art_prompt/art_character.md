---
name: art_character
description: 2D中国国风角色基础图视觉手册。将资产事实与视觉设计推导编译为可复用的图片提示词。
metaData: art_skills
---
# 人物基础形象生成 · 约束手册
...
本手册负责把已确认事实编译为2D中国国风角色基础图提示词，不负责创作剧情、身份、关系、地点、品牌、能力或世界规则。
...
```text
2D中国国风角色设定图，character design sheet，character turnaround，
{来自 assetFoundation 的年龄、性别、身份、面部、体态、发型和基础服装事实}，
{来自 visualDesignRationale 的识别度策略、观众缘处理和审美修正}，
服装轮廓、发式与饰物服从已确认时代和身份，线条有提按变化，避免符号化脸谱，
