---
name: art_prop
description: 2D中国国风道具基础图视觉手册。将资产事实与视觉设计推导编译为可复用的图片提示词。
metaData: art_skills
---
# 道具图像生成 · 约束手册
...
本手册负责把已确认事实编译为2D中国国风道具基础图提示词，不负责创作剧情、身份、关系、地点、品牌、能力或世界规则。
