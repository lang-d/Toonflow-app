...
视觉规划必须从剧本的时代、地点、身份、礼仪和行动事实出发。手册提供东方绘画和二维动画的转译方法，不新增门派、法器、纹样含义或历史制度。题材叙事决定冲突，本手册决定冲突如何在空间和画面中被看见。
...
每场选择一个主墨色、一个身份或情绪强调色，并说明颜色随关系变化如何增减。线条粗细服务前后层次和人物状态：稳定段落线条收敛，冲突段落可增强转折但不能破坏角色一致性。自然光、灯笼、烛火与月光必须有清楚方向；不使用无来源霓虹和现代舞台光。
...
- 留白必须承担距离、孤立、等待或未知，不是空洞背景。人物行动方向应朝向或逃离留白区域，形成明确读图路径。
- 山水、庭院和长街可按卷轴式横向层次组织，但同一场景要固定地标、门窗、台阶和水岸方向，避免每镜重绘成不同空间。
- 近景用深色枝叶、帘幕或建筑构件框景，中景承载人物动作，远景说明地理和气候；层次不可同时抢夺注意力。
- 传统纹样只在身份、地点或仪式有事实依据时出现，同场限制主纹样种类，避免符号拼盘。

### 类型专属应用：礼仪站位与轴线

先以建筑中轴、席位高低、门槛和屏风建立权力空间，再确定人物站位。进入、跪坐、行礼、递物、拔刃等动作必须写出起点、路径和结束姿态。对话遵守视线与场景轴线；需要越轴时，利用人物绕席、穿门或正轴构图完成可见重建。群像按身份形成前后和左右层级，不能平均排队。
...
表演以眼神延迟、袖摆、呼吸、手势和距离变化承载情绪，夸张变形只用于题材允许的明确喜剧段。动画资源优先给衣袖惯性、发饰余摆、武器接触和水墨转场中的因果节点。声音只标注风、水、木构、衣料、脚步和礼器等画内信息；音乐描述器乐质地与进退功能，不编写旋律或歌词。

## 导演规划应用检查

每场给出视觉意图、留白用途、主辅色、空间层次、建筑轴线、人物身份站位、入口出口、关键动作连续性、覆盖机位和禁用元素。若史实未知则明确待确认，不用“古风化”填补事实。

## 禁止项

禁止金龙祥云等元素无依据堆叠；禁止把留白等同纯白背景；禁止空间轴线随构图任意翻转；禁止输出固定剧情、生成提示词和渲染参数。
