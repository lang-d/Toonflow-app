---
name: art_scene
description: 2D成熟都市言情场景基础图视觉手册。将资产事实与视觉设计推导编译为可复用的图片提示词。
metaData: art_skills
---
# 二次元场景图生成 · 约束手册
...
本手册负责把已确认事实编译为2D成熟都市言情场景基础图提示词，不负责创作剧情、身份、关系、地点、品牌、能力或世界规则。
...
```text
2D成熟都市言情场景设定图，environment design sheet，location reference，single image，
...
公共与私密空间层级清楚，玻璃、金属、织物和木饰面体现都市阶层与关系距离，{已确认时段、天气和实际光源}，
