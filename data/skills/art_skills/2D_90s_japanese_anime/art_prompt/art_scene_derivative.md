...
description: 90年代日式动画场景衍生图视觉手册。将资产事实与视觉设计推导编译为可复用的图片提示词。
metaData: art_skills
---
...
本手册负责把已确认事实编译为90年代日式动画场景衍生图提示词，不负责创作剧情、身份、关系、地点、品牌、能力或世界规则。
...
```text
90年代日式动画场景衍生设定图，based on the reference scene design，same location，single image，
...
手绘背景、空气透视与前中后景色阶，光影采用可绘制的曝光层级而非数字霓虹堆叠，保持一致的材质响应和可追溯光源，
