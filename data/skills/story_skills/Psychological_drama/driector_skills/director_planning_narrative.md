...
只使用剧本确认的欲望、秘密、关系和行为。心理状态必须通过人物任务、话语策略、目光、距离、道具控制和选择后果显形，不新增诊断、童年创伤或幻觉。内心独白不能替代可见行动。

先建立主客观边界。若剧本存在记忆、想象或感知偏差，规划进入和退出的明确触发，并列出主观段可见但未被确认的内容。客观空间的门、座位、镜面和人物位置保持稳定。构图或轴线变化可表现权力翻转，但必须由走位、视点或场景事件建立。
...
- 每场标记谁发起议题、谁控制信息、谁控制空间、谁能结束谈话，以及这些权力何时转移。
- 试探通过问题、回避、物件位置或距离变化展开，不能泛化为“压迫感增强”。
- 沉默必须说明人物在观察、拒绝、计算还是承受，且之后产生可见选择。
- 胜负不是说服对方的台词，而是信息、位置、行动权限或关系发生变化。
...
表演关注呼吸控制、答非所问、目光停留、手物关系和身体占位，避免统一皱眉与慢动作。声音突出房间底噪、物件操作和被打断的语句；配乐在信息不确定时保持中性，不替观众诊断人物。
...
每场写明显性目标、隐藏策略、权力四项状态、信息差、空间控制、主客观标识、转移触发和行动后果。心理解释没有事实支持时保留多义。

## 禁止项

禁止新增精神疾病、幻觉和秘密；禁止用镜头混乱代替心理复杂；禁止无动机越轴和镜面谜语；禁止生成参数。
