...
从剧本提取灾变状态、环境危险、技术能力、资源数量、组织规则和人物知情情况。未写明的感染方式、科技功能、避难所制度和怪物能力不得补充。末世压力必须通过资源、时间、地理或信任的可见限制呈现。
...
- 每场明确当前生存目标、可用资源、消耗速度、阻碍和失败后果。
- 搜索、修复、转移、封锁和救援写成准备、执行、反馈和结果，不能一句“完成”带过。
- 技术设备先说明输入、可见状态和输出；故障必须符合已建立规则。
- 人性选择建立在具体资源与风险上，不能用抽象“牺牲还是自私”替代人物处境。

### 类型专属应用：地理与群体关系

规划安全区、危险区、路线、遮蔽物、观察点和撤退口。跨地点行动保持方向、耗时及携带物状态。群体场面记录谁掌握资源、信息和通行权，关系变化通过分配、拒绝、等待或共同承担显形。
...
疲劳、饥饿、污染恐惧和警戒服从剧本事实，通过动作效率、呼吸、检查习惯和距离表现。声音区分环境危险、设备状态和人物行动；警报必须有规则含义，配乐不得持续覆盖信息。
...
每场写明世界规则、资源账、时间压力、目标、行动链、技术状态、地理路线、群体权限、选择与后果。未知规则标待确认。

## 禁止项

禁止新增灾变设定、装备和敌人；禁止资源无因恢复；禁止科技万能化和废墟装饰化；禁止模型与视觉参数。
