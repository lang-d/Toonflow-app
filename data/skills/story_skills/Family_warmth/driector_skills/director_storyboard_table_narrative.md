...
不发明家庭事件，不输出视觉风格或图片生成文本；景别、时长、字段及资产引用服从通用分镜表契约。
...
按家庭任务变化、关系转向、照料被接受或拒绝、人物离席或回到共同空间拆镜，不按每句家常对白切换。优先让一个镜头同时保留说话、做事和他人反应，维持共同生活的真实密度。
...
争执中生活动作可以中断，镜头必须记录中断点及之后是否恢复。温情落点给行动结果和被照料者的真实回应，不用连续泪眼特写。门、餐具、食物、衣物等状态跨镜一致。
...
- 餐桌先建立座位和空位，再用视线、递物和停筷表现关系；不得让人物在反打中换座。
- 厨房、门口和狭窄过道先说明谁占据通道、谁让路及谁能离开。
- 多人场面用层次构图保留旁观反应，切单人镜只在行动或关系状态发生改变时。
- 手部细节只拍决定性的照料、拒绝、归还或停止动作，并连接动作前后。
...
对白场保持视线链和动作任务，停顿不等于人物静止。生活声可连接空间或揭示有人回家、离开、继续工作；转场通过完成的家庭任务或空间出口建立，不能新增团圆含义。
