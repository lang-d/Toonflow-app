...
先确认家庭成员、共同生活事实、当前任务和冲突，不新增亲属、疾病、旧事或牺牲。温情来自人物在现实压力中的选择与照料，不等于始终和睦。记录每个人想维护什么、回避什么、通过何种日常行动表达。
...
- 做饭、吃饭、收拾、等候、递物、开门等动作只有在剧本存在时使用，并明确谁发起、谁接受或拒绝。
- 同一物件经过不同人之手时，记录状态和关系含义，不用强行象征。
- 冲突段保留家务或生活任务的持续，使台词压力有现实落点。
- 和解不能只靠拥抱或煽情音乐，必须有新的行动、让位、承担或回应。

### 类型专属应用：家庭空间与代际站位

餐桌体现参与和隔离，厨房体现照料与劳动，门口体现接纳或离开，走廊与房间体现公开和私下。按剧本场所建立座位、视线和出入口。多人场面区分正在行动者、被影响者和旁观者；儿童、老人或行动受限者的调度服从事实与安全。
...
表演强调熟悉关系中的省略：不用看就递物、说重话仍继续照料、想靠近却维持距离。每个沉默标明人物正在做什么及看向哪里。声音保留锅具、电视、门锁、脚步和邻里环境，配乐为对白和生活声让位。
...
每场写明家庭任务、显性冲突、隐藏维护对象、关系初末位置、生活动作链、空间出口和可见后果。温情强度服从剧本，不制造团圆结论。

## 禁止项

禁止新增苦难和回忆；禁止用儿童老人作为自动催泪工具；禁止机械拥抱、围桌微笑和配乐代替行动；禁止视觉与模型参数。
