...
确认组织、职位、汇报关系、当前任务、决策权限、证据和截止条件。不得新增公司制度、商业数据、违法证据或幕后关系。职场张力来自谁能决定、谁掌握信息、谁承担结果，而非所有人都说强硬台词。
...
- 开场明确会议或行动目标，以及每个人公开目标与可见限制。
- 发言、文件、屏幕和电话必须改变信息、权限或下一步行动。
- 试探与反制基于已有利益和证据，不能靠突然出现的内幕。
- 权力转移通过座次、谁能打断、谁获得文件、谁被要求行动或谁离开会议表现。
- 结果落到任务、职位关系、资源或时间压力，不以一句“散会”结束。
...
会议室记录座位、屏幕、门和主导位置；开放办公区记录旁观压力与通行路线；独处空间表现人物重新判断而非空泛疲惫。人物走向屏幕、递交文件、关闭电脑或离席要有权限和策略意义。对话轴线保持座次可辨。
...
表演使用准备程度、答复速度、措辞控制、文件处理和身体占位。情绪爆发必须有职业后果。声音保留键盘、通知、电话、门和空调等工作环境，配乐不把正常业务自动拍成阴谋。
...
每场写明任务目标、职权、利益、证据状态、谈判动作、信息变化、座次与出口、决策和现实后果。专业事实未知时待确认。

## 禁止项

禁止新增商业常识作为剧情事实；禁止用屏幕乱码和摔文件代替博弈；禁止所有上司霸凌化；禁止视觉模型参数。
