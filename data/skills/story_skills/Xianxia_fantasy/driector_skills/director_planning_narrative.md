...
只整理剧本确认的修行规则、境界、门派、法术、法器、誓约、因果和人物能力。未知名称、等级、招式与神话背景标记待确认，不能按类型惯例补完。仙侠感来自人物在规则、代价和选择中的行动，不来自持续特效。
...
- 明确人物被什么规则、身份或誓约限制，以及当前仍拥有何种选择。
- 修行或能力使用写清条件、过程、代价和结果，不能只写“爆发”。
- 阶序通过谁能进入、发言、授予、惩戒或拒绝体现，不靠服装颜色臆断。
- 宿命信息改变人物目标时，必须落到接受、违抗、隐瞒或承担等行为。
- 情感与大战都要回到人物选择及关系后果，不让世界观说明吞没场面。
...
先建立真实地理、人物站位和攻击方向，再叠加法阵、飞行或能量路径。仙术有发起点、传播路径、目标、抵抗和落点；跨空间能力必须符合剧本规则。群战区分阵营、领队和协作链，不能在特效中任意换位。
...
表演通过礼数、克制、呼吸、身体承受和对誓约的回应表现。声音区分环境、兵器、术法反馈与规则性信号；音乐只描述仪式、压迫或释放的功能，不规定曲目。
...
每场写明规则、阶序、誓约压力、人物选择、能力条件与代价、空间轴线、动作链、关系后果和待确认事实。

## 禁止项

禁止新增境界、法宝、天劫和反派；禁止无限升级与特效堆叠；禁止用宿命旁白替代选择；禁止生成模型与渲染参数。
