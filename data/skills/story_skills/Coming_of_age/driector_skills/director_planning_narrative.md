...
**成长链**从剧本中找出人物当前相信什么、想跨过什么门槛、因何选择、犯了什么可见错误、承担何种代价，以及行为如何证明认知变化。成长不能只靠旁白或“变成熟了”的结论，必须落到再次面对相似情境时不同的行动。
...
- 起点呈现人物能力、身份或关系的现实限制，不额外制造创伤。
- 尝试段让人物主动迈步，并保留笨拙、兴奋或过度自信的动作证据。
- 错误段明确选择与后果之间的因果，不能把成长全部归因于外部打击。
- 代价段通过失去机会、关系距离或责任压力显形，不泛化苦情。
- 转变段回收早先动作、地点或物件，让新选择可被比较。
...
为关键关系记录距离、同行方向、谁等待谁、谁先离开。学校、家庭、街道或工作场所只使用剧本存在的区域，并以门槛、座位、路线和群体位置表现归属变化。人物跨越场景轴线可对应主动选择，但必须由可见走位建立。
...
蒙太奇只压缩重复过程，仍要保留第一次尝试、失败变化和最终证据。表演强调犹豫、模仿、试探、承担和重新发起。声音可用熟悉环境声的变化表现阶段，但音乐不能替代选择与后果。
...
每场写明成长阶段、当前信念、门槛、行动、错误或代价、关系位移、空间触发和可比较的行为证据。剧本未完成成长时保留未决状态。

## 禁止项

禁止新增校园事件、家庭创伤或导师；禁止用换装和成功蒙太奇代替成长；禁止固定视觉风格、模型参数和歌曲。
