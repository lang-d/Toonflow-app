...
不新增成长事件或关系结论，不输出视觉风格与图片生成文本；字段、景别和时长遵守通用分镜表技法。
...
以人物首次尝试、选择改变、错误显现、代价落地和再次选择作为切点。连续学习或生活过程可以合并，但每组镜头必须保留阶段差异，不能只做无因的青春氛围拼贴。
...
- 先建立人物与门槛、群体或重要他人的空间关系，再进入局部反应。
- 同一路线、座位、动作或剧本物件再次出现时，保持基本构图关系，让站位、速度或完成方式显示成长。
- 同行场面优先用双人关系镜观察步速与距离；只有关系断裂或决定形成时才拆成孤立单人镜。
- 手、脚和物件细节必须对应尝试或选择，不能用空泛特写制造文艺感。

### 类型专属应用：时间省略与连续

时间省略使用服装、光线、环境状态或动作进度等剧本事实建立，不新增日期。动作方向和入口出口跨段保持可追踪。成长节点应给行动完成及他人反馈的可见时间，不在结果前切走。
...
犹豫镜头按人物做决定所需反应留量；重复过程逐步压缩，最终选择重新放开。对白不逐句正反打，沉默时仍要记录目光对象和身体任务。声音回收熟悉环境或物件声，音乐仅作段落边界。
