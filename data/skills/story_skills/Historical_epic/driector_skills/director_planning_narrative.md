...
只使用剧本确认的时代、政权、人物、事件、军队和制度。未知史实标记待确认，不能用常识补写。史诗感来自个人选择影响群体、制度或地理局势的可见因果，而非单纯人数、口号和大全景。
...
- 每场确认决策者、执行者、承受者和见证者，以及命令如何传递、被延误或被抵抗。
- 宫廷、议事、军阵和民众场面分别建立权力站位，群体不是无差别背景。
- 大事件拆为可追踪行动链：信息到达、决策形成、命令传出、行动发生、后果返回。
- 个人情感段仍需保留其与公共责任或历史压力的连接，不用旁白概括时代。

### 类型专属应用：地理、时间与场面调度

先建立城门、道路、阵地、河流、宫门等剧本地理，再规划群体方向。多地点并行时标明各方知情状态和时间关系。阵列变化、进退和仪式动作要有发起信号与结果；越轴不得颠倒敌我或权力方位。
...
权力通过等待时长、发言顺序、座次、距离和谁能打断谁体现。个人决定要有身体行动和现实代价。声音区分命令、群体回应、器械、马匹和场所回响；音乐不能把尚未发生的胜败提前定性。
...
每场写明历史事实来源状态、公共压力、个人目标、决策链、地理方向、权力站位、群体行动、后果和待确认项。视觉风格与规模不得改写史实。

## 禁止项

禁止新增战役、人物和制度；禁止“千军万马”式空泛规模词；禁止群演无目的奔跑；禁止生成参数和固定音乐。
