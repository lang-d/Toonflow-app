...
先把剧本中每条线索分为事实、角色解释、谎言和未确认信息，并记录谁在何时知道。不得新增证据、嫌疑人、动机或幕后关系。悬疑来自信息分配与判断代价，不来自故意漏拍剧本已给观众的必要事实。
...
- 提问段明确当前要解决的问题和可调查范围，避免同时抛出无关谜团。
- 发现段呈现线索的来源、状态与发现者，线索不能凭台词凭空出现。
- 解释段区分事实和角色推断；错误推断必须能追溯到已有信息。
- 验证段让人物采取行动并承担风险，不能只靠连续对话分析。
- 揭示段回收先前可见事实，说明知情状态和行动目标如何改变。
...
误导可以改变观众对事实的解释，但不能隐藏同一视点理应看见的关键动作。场景规划记录证据位置、观察路线、遮挡关系、出入口和人物视线。跟踪、偷听或搜索必须符合距离与地理，越轴不得颠倒观察者和被观察者。
...
表演区分知道、怀疑、试探、撒谎和确认：通过回答延迟、目光目标、保护物件和行动路线表现，不统一拍成阴沉。声音线索写清来源、可听范围和哪些角色听见；配乐不得给未经证实的人贴“凶手”标签。
...
每场写明核心问题、线索真值、知情变化、当前解释、验证行动、空间位置、误导边界和揭示后果。未知事实保持未知。

## 禁止项

禁止新增线索和反派；禁止用异常特写把普通物件伪装成证据；禁止隐藏必要事实制造反转；禁止视觉提示词与模型参数。
