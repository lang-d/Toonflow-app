...
从剧本确认参战者、目标、能力、场地、规则和胜负结果。不能新增招式、装备、援军或破坏规模。热血来自人物在阻碍与代价下继续选择，不来自持续呐喊和无上限升级。

### 类型专属应用：能量段落

- 起势段建立目标、距离、可用路线和双方优势。
- 试探段通过一次完整攻防暴露规则，不堆无结果动作。
- 受挫段明确失败原因和可见代价，让人物策略发生变化。
- 协作或反击段必须回收已建立能力、关系或场地条件。
- 落点段确认胜负、伤势、资源和关系后果，不在冲击瞬间结束规划。

### 类型专属应用：空间、动作轴线与伙伴关系

建立攻击轴线、移动路线、高低差和危险边界。每个关键动作写清发起、目标、阻挡、接触、受力和落点。方向改变需由绕位、翻越或击退等可见动作完成。伙伴协作记录谁创造机会、谁执行、谁承担风险，禁止所有人同时无序攻击。
...
疲劳、疼痛和决心通过呼吸、重心、动作完成度与重新站起表现。台词只能发生在有合理行动窗口的位置。声音区分预备、接触、环境破坏和余响；音乐在策略与情绪节点变化，不替代打击反馈。
...
每场输出目标、规则、优势、能量阶段、动作轴线、关键攻防链、伙伴分工、代价、落点和连续性风险。能力未知或资产不足时待确认。

## 禁止项

禁止新增技能与战果；禁止连续无因爆炸、慢动作和环绕；禁止忽略伤势与道具状态；禁止生成参数与固定歌曲。
