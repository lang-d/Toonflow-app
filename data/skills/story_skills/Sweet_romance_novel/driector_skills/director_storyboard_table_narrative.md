...
不发明暧昧和亲密行为，不输出视觉风格、图片生成文本或歌曲；字段与时长遵循通用分镜表契约。
...
试探给对方回应所需时间，误解段保留信息差来源，回报段让动作完成和人物理解可见。公共空间维持他人、噪声和通行约束；转入私密空间必须有剧本动作和入口出口连续。
...
试探发起、对方确认或拒绝、距离变化、误解生效、行动回应和关系回报时拆镜。不要逐句拍脸，也不要把所有停顿都切成眼睛、手和嘴的连续特写。

### 类型专属应用：目光、触碰与距离

- 先用关系镜建立两人距离、障碍和退路，再进入局部动作。
- 目光镜注明看向对象及对方是否察觉；视线不能在反打中跳位。
- 触碰按接近、确认、接触、反馈和结束保持连续，剧本没有对方反馈时不得替其接受。
- 递物、让路、并肩等小动作要连接关系前后状态，不作为无意义糖点重复。
...
环境声可在注意集中时降低，但不能无因消失。配乐不提前替人物确认关系。转场可回收共同任务或物件，不新增约会和时间跳跃。
