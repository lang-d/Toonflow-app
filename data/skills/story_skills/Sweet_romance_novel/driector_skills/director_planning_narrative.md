...
确认剧本中的关系阶段、双方目标、已表达边界、误解来源和实际行动。不得新增暧昧、亲密接触、占有行为或关系确认。甜来自双方在理解和尊重边界后提供的具体回应，不是单方面逼近或持续脸红。
...
- 注意：人物开始观察对方的具体需要或变化，但不擅自解释。
- 试探：通过问题、邀请或小行动确认对方意愿，并保留接受、犹豫或拒绝。
- 回应：对方以行动回应，关系距离或共同任务产生可见变化。
- 误解：只使用剧本已有信息差，重点规划误解怎样影响选择，而非无限拖延沟通。
- 回报：回收早先需求、承诺或物件，让亲密感来自被理解。
...
记录两人初末距离、谁先靠近、是否留有退路和障碍物怎样变化。目光、触碰、递物和并肩都必须有动作前因与对方反馈。公共与私密空间影响人物表达强度，但不能凭环境自动升级关系。表演采用关注、等待、确认和收回，避免模板化害羞。

### 类型专属应用：声音与节奏

对白间停顿服务确认意愿或理解信息，音乐不代替回应。环境声可突出两人从群体中获得短暂共同空间，但不让世界无因消失。
...
每场写明关系阶段、双方目标、边界、试探动作、反馈、距离变化、误解事实和微小回报。剧本未确认的关系保持未确认。

## 禁止项

禁止新增亲密动作、强制浪漫化和霸道行为美化；禁止反复偶遇与误会；禁止靠柔光慢镜代替推进；禁止生成参数。
