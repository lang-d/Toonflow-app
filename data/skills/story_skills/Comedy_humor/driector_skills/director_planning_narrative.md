...
先从剧本识别谁想完成什么、观众被建立了什么预期、现实怎样偏离预期，以及偏离给角色造成什么可见后果。笑点必须生长于人物目标、性格或处境；剧本没有的误会、巧合、包袱和配角不得补写。
...
- 铺垫段只交代理解笑点所需事实，并让关键物件、规则或人物习惯自然出现。
- 误导段让角色和观众形成可验证预期，不用隐藏必要事实制造强行反转。
- 升级段每次增加阻碍或暴露代价，不能重复同一动作只提高音量。
- 回收段让早先事实产生新意义，随后保留角色反应或现实后果，不要笑点一响就切走。
- 多个笑点组成节拍链时，标明主笑点、次反应和最终落点，避免互相抢夺。
...
喜剧冲突通过人物认真执行各自目标产生。规划谁掌握信息、谁误判、谁观察以及信息何时转移。多人场面为发起者、受影响者和旁观反应者安排稳定站位，保证视线链可追踪。越轴或构图失衡只能在剧本已有动作触发且本身构成笑点时使用，之后立即重建空间。
...
表演使用确信、迟疑、掩饰、停顿和失败后的补救，不要求演员主动“演好笑”。声音明确铺垫静默、动作同步点、意外声源和回收位置；配乐不得提前泄露包袱，也不替角色反应。
...
每场写明人物目标、观众预期、误导事实、升级阶梯、主笑点触发、反应链、可见后果、人物初末位置和信息状态。没有笑点条件的段落按剧情功能处理，不强行喜剧化。

## 禁止项

禁止新增段子、网络梗和巧合；禁止用羞辱弱者代替结构；禁止泛化“夸张表演”；禁止摄影参数、视觉提示词和歌曲设计。
