...
从剧本整理威胁是否真实、角色知道什么、观众知道什么、威胁能做什么以及不能做什么，并标明尚未确认的未知边界。未确认的鬼怪形态、死亡规则、背景故事和惊吓不得新增。恐惧来自规则下的信息缺口与选择代价，而不是随机异象。
...
- 每个遮蔽都要说明被遮住的对象、观察者和揭示条件，不能无限拖延已有事实。
- 先建立正常状态，再让声音、物件、光线或人物行为出现可比较变化。
- 假警报必须来自场景已有因素并改变角色判断，不能只消耗注意力。
- 真正揭示后保留角色行动与空间后果，不立即用下一次惊吓覆盖。
...
规划入口、出口、盲区、声源、避难点和威胁可能路径。角色逃跑、寻找或封锁时维持移动方向和门窗状态。主观镜头明确观察者及视野限制，切回客观镜头时重新定位。不能借跳切让威胁无规则换位。
...
恐惧表演经历察觉、确认、抑制、选择和行动，不是一开始持续尖叫。声音写清来源、距离、重复规律和何时消失；静默必须改变角色判断。配乐不提前宣布威胁位置，也不替代画内线索。
...
每场写明正常基线、威胁规则、角色/观众知情差、遮蔽对象、揭示触发、逃生地理、动作选择和后果。规则未知时显式标注，不补世界观。

## 禁止项

禁止随机闪现、无规则瞬移和滥用跳吓；禁止新增伤亡与灵异设定；禁止用黑画面掩盖空间；禁止视觉模型参数。
